...
instructions.1: "Вы можете менять расположение фото: поворачивать, увеличивать или уменьшать его так,"
...
step.1.title: 'Step 1:'
step.1.description: select an image
step.2.title: 'Step 2:'
step.2.description: select a color
